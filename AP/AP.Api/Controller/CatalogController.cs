...
namespace AP.Api.Controller
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<CatalogDetailsDto>> CreateAsync([FromBody] CatalogNewDto newItem)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<CatalogDetailsDto>> UpdateByIdAsync(string id, [FromBody] CatalogNewDto newItem)
        {
